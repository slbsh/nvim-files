...
hi('CursorLineNr',   { fg = GrayLit,     bg = Bg0                               })
hi('LineNr',         { fg = Gray,        bg = Bg0                               })
hi('ColorColumn',    {                   bg = Bg1                               })
hi('FoldColumn',     { fg = Gray,        bg = Bg1                               })
hi('SignColumn',     { fg = Gray,        bg = Bg0                               })
...
hi('DiffChange',     { fg = YellowLit,                                          })
hi('Added',          { fg = Green,                                              })
hi('Removed',        { fg = Red,                                                })
hi('Changed',        { fg = YellowLit,                                          })
hi('DiffText',       { fg = Fg                                                  })
hi('GitSignsStagedAdd',   { fg = Green,             bold = true                 })
hi('GitSignsStagedDelete',{ fg = Red,               bold = true                 })
hi('GitSignsStagedChange',{ fg = YellowLit,         bold = true                 })
