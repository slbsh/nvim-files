...
require('which-key').add({
   ...
   {"<leader>gD", ":Git diff HEAD<CR>",                        desc = 'diff'},
   {"<leader>gd", ":Git diff HEAD --staged<CR>",               desc = 'diff staged'},
   ...
   {"<leader>gP", group = 'Pull'},
   {"<leader>gPf", ":Git fetch<CR>",            desc = 'fetch'},
   {"<leader>gPp", ":Git pull<CR>",             desc = 'pull'},
   {"<leader>gPP", fetch_pull,                  desc = 'fetch pull'},
   {"<leader>gPr", ":Git pull --rebase<CR>",    desc = 'pull rebase'},
   {"<leader>gPm", ":Git pull --no-rebase<CR>", desc = 'pull merge'},
   {"<leader>gPf", ":Git pull --ff-only<CR>",   desc = 'pull fast-forward'},
   ...
   {"<leader>ec", ":Run tcc -run -<CR>",       desc = "c"},
